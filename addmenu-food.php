    ...
    <div class="kotak4">
        <form action="" method = "post" enctype="multipart/form-data">
          <label for="">Type of Food: </label>
            ...
            <button type="submit" name="append" id="button1" class="btn btn-primary deep-purple btn-block">Append</button>
        </form>
    </div>
...
if(isset($_POST['append'])){
    ...
    $query = "INSERT INTO makanan (tipe, nama, gambar, harga, tanggal)
    VALUES ('$tipe', '$nama', '$gambar_baru', '$harga', '$tanggal')";
      $result = $db->query($query);
    if($result){
        echo "
            <script>
                alert('Successfully Append Menu');
                document.location.href = 'read-menus.php';
            </script>
        ";
