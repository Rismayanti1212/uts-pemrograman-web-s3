...
<body>
    ...
    <div class = "parent-konten-1"  align ="center">
        <div>
            <img id = "konten1" src = "img/dessert1.jpg">
            <a><br>
                <mark class = "hightlight">Cookies and Cream Parfait</mark><br>
                <mark class = "hightlight"><i> Rp. 125.000,- </i></mark>
            </a>
        </div>
        
        <div>
            <img id = "konten1" src = "img/beverage3.jpg">
            <a><br>
                <mark class = "hightlight">Iced Blackberry Infused Earl Grey Tea</mark><br>
        ...
        <div>
            <img id = "konten1" src = "img/main-course4.jpg">
            <a><br>
                <mark class = "hightlight">Stuffed Portobello Mushrooms</mark><br>
    ...
    <div class = "parent-konten-2"  align ="center">
        ...
        <div>
            <img id = "konten2-1" src = "img/main-course5.jpg">
            <a><br>
        ...
        <div>
            <img id = "konten2-1" src = "img/main-course6.jpg">
            <a><br>
    ...
    <div class = "parent-konten-3"  align ="center">
        <div>
        ...
        <div>
            <img id = "konten3-1" src = "img/chef3.jpg">
        </div>

        <div>
            <img id = "konten3-1" src = "img/chef4.jpg">
        </div>
    ...
    <div class = "border-reserv" align = "right">
        <div>
          ...
          RESERVE YOUR TABLE NOW!!!
            <div class = "button-reserv"><a href="#">BOOKING NOW</a></div>
        </div>
