...
<?php
require 'config.php';
$result = mysqli_query($db, "SELECT * FROM order_online");
?>
...
<table class = "table" border = 5 align = "center">
    <tr>
        <th colspan = '10'>Preview Booking Table</th>
    </tr>
    <tr>
        <th>No</th>
        <th>Nama</th>
    ...
    <tr>
        ...
        <td><?= $row['jumlah']; ?></td>
        <td><?= $row['note']; ?></td>
        <td><a href="delete-order.php?id=<?=$row['id']?>">Delete</td>
    </tr>
    <?php 
     $i++;
        }
    ?>
    <tr>
         <th colspan = '10'><a href = "our-service-booking-table.php">+ Order</a></th>
    </tr>
    </table>
</div>
