    ...
    if($result){
        echo "
            <script>
                ...
                document.location.href = 'update-beverage.php';
            </script>
        ";
  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Menu Beverage</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->


    <div><h1 class="teks3" align = "center">UPDATE MENU BEVERAGE</h1></div>
    <div class="kotak4">
