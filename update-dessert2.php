    ...
    if($result){
        echo "
            <script>
                ...
                document.location.href = 'update-dessert.php';
            </script>
        ";
  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Menu Dessert</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <div><h1 class="teks3" align = "center">UPDATE MENU DESSERT</h1></div>
    <div class="kotak4">
